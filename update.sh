...
for version in "${versions[@]}"; do
	...
	(
		...
		' "$version/Dockerfile" "$version/slim/Dockerfile" "$version/wheezy/Dockerfile" "$version/trusty/Dockerfile"
		rm $version/Dockerfile.bak $version/slim/Dockerfile.bak $version/wheezy/Dockerfile.bak $version/trusty/Dockerfile.bak
